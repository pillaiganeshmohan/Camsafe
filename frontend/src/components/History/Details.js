        ...
        <table>
          ...
          <div className="flex flex-col justify-center items-center sm:w-full">
            <div className="flex w-6/12 justify-between py-2 sm:w-9/12">
              <label className="w-1/4 sm:w-1/2">Subject ID</label>
              <label className="w-1/4 sm:w-1/3">1121</label>
            </div>
            <div className="flex w-6/12 justify-between py-2 sm:w-9/12">
              <label className="w-1/4 sm:w-1/2">Subject Name</label>
              <label className="w-1/4 sm:w-1/3">Pasta Haha</label>
            </div>
            <div className="flex w-6/12 justify-between py-2 sm:w-9/12">
              <label className="w-1/4 sm:w-1/2">Subject Gender</label>
              <label className="w-1/4 sm:w-1/3">Male</label>
            </div>
            <div className="flex w-6/12 justify-between py-2 sm:w-9/12">
              <label className="w-1/4 sm:w-1/2">Subject Age</label>
              <label className="w-1/4 sm:w-1/3">22</label>
            </div>
            <div className="flex w-6/12 justify-between py-2 sm:w-9/12">
              <label className="w-1/4 sm:w-1/2">Subject Aadhar No.</label>
              <label className="w-1/4 sm:w-1/3">XXXX XXXX XXXX</label>
            </div>
            <div className="flex w-6/12 justify-between py-2 sm:w-9/12">
              <label className="w-1/4 sm:w-1/2">Subject Location</label>
              <label className="w-1/4 sm:w-1/3">Belapur</label>
            </div>
            <div className="flex w-6/12 justify-between py-2 sm:w-9/12">
              <label className="w-1/4 sm:w-1/2">Longatide & Latitude</label>
              <label className="w-1/4 sm:w-1/3">13.2074° N, 74.7718° E</label>
            </div>
            <div className="flex w-6/12 justify-between py-2 sm:w-9/12">
              <label className="w-1/4 sm:w-1/2">Subject Date & Day</label>
              <label className="w-1/4 sm:w-1/3">XX/XX/XX & Thursday</label>
            </div>
            <div className="flex w-6/12 justify-between py-2 sm:w-9/12">
              <label className="w-1/4 sm:w-1/2">Percentage(%)</label>
              <label className="w-1/4 sm:w-1/3">70</label>
            </div>
            <a href="/history" className=""><button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-2 rounded-full w-40 h-16 text-xl">Back</button></a>
          </div>
      </div>
    </div>
  );
